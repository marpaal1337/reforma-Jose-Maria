...
#hint{pointer-events:auto;background:var(--panel);border:1px solid var(--line);border-radius:999px;
  padding:8px 13px;box-shadow:var(--shadow);font-size:11px;color:var(--muted)}
...
#fallback{display:none;position:fixed;inset:0;z-index:50;place-items:center;background:var(--paper);text-align:center;padding:24px}
...
@media (max-width:820px){
  ...
  #hud{left:10px;bottom:118px;max-width:min(240px,56vw)}
...
<div id="hud">
  ...
  <div id="hint"><kbd>Arrastrar</kbd> mirar · <kbd>Rueda</kbd> zoom · <kbd>←</kbd><kbd>→</kbd> estancias · <kbd>Espacio</kbd> girar</div>
</div>
...
<div id="fallback">
  <div>
    ...
    <p>Puedes ver la reforma en <a href="render3d.html">el visor 3D</a> o en <a href="planos.html">los planos 2D</a>.</p>
  </div>
</div>
